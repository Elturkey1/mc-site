<?php
$server_ip_name = "kwoxy.batihost.net"; // Your server IP
$home_subtitle = "Eğlenceli ve sade survival'ın adresi"; // Subtitle of the homepage
...
$status_title = "Sunucu durumu"; // Title on status page
$store_title = "Rütbe satın al"; // Title on store page
