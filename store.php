		...
		<div class="row store-items">
			<div class="col-md item">
				...
				<div class="big-col-text">
					<img class="res-img-sm" src="./img/iron.png" height="300px" width="300px"> <br /><br />
					<h2>Vip</h2>
					<p>1 Ay</p><br />
					<p class="price">5TL</p>
					<a class="button" href="contact.php">İletişim</a>
				</div>
			</div>
			<div class="col-md item">
				<p class="big-col">&nbsp;</p>
				<div class="big-col-text">
					<img class="res-img-sm" src="./img/gold.png" height="300px" width="300px"> <br /><br />
					<h2>Vip+</h2>
					<p>1 Ay</p><br />
					<p class="price">7TL</p>
					<a class="button" href="contact.php">İletişim</a>
			...
			<div class="col-md item">
				<p class="big-col">&nbsp;</p>
				<div class="big-col-text">
					<img class="res-img-sm" src="./img/diamond.png" height="300px" width="300px"> <br /><br />
					<h2>MegaVip</h2>
					<p>1 Ay</p><br />
					<p class="price">10TL</p>
					<a class="button" href="contact.php">İletişim</a>
				</div>
			</div>
            <div class="col-md item">
				<p class="big-col">&nbsp;</p>
				<div class="big-col-text">
					<img class="res-img-sm" src="./img/emerald.png" height="300px" width="300px"> <br /><br />
					<h2>UltraVip</h2>
					<p>1 Ay</p><br />
					<p class="price">15TL</p>
					<a class="button" href="contact.php">İletişim</a>
				</div>
			</div>
		</div>
